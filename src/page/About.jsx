        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 mt-20 md:grid-cols-2">
            <div className="mt-4 ml-4">
              ...
              <h2 className="text-5xl font-bold font-satoshi text-textbg-500">
                Console
              </h2>
            </div>
            <div className="w-11/12 mx-auto mt-6 text-textbg-500 font-satoshi">
              <h2 className="leading-tight md:text-3xl">
                Feeling lost in a समुन्दर of web dev and design resources?
                Console to the rescue!
              </h2>
              <br />
              <h2 className="text-xl tracking-wider text-left md:text-2xl">
                We offer a meticulously curated collection of tools, tutorials,
                and learning materials, all chosen by experienced developers and
                designers like you. Focus on what you do best – unleashing your
                creativity and building ज़बरदस्त web experiences. Stop those
